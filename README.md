...
| **Sistema de Auditoria** | Script de automação financeira que utiliza recursividade para consolidar orçamentos em dicionários aninhados e decorators para auditoria de performance e logs. | [Ver Projeto] ()
